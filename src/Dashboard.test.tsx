...
jest.mock('./apiClients/productsApiClient/productsApiClient')
...
describe('Given the Dashboard component', ()=>{
    beforeEach(()=>{
        mockFetchAllProducts.mockClear()
    })
    ...
    test('it displays the products list', async ()=>{
        
        mockFetchAllProducts.mockResolvedValueOnce(sampleProductsList)
        renderDashboard()
